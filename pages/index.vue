    ...
    <div class="p-4 w-full">
      <div class="grid grid-cols-10 gap-4">
        <div class="col-span-12 sm:col-span-6 md:col-span-3">
          <nuxt-link to="/" target="_blank" class="flex flex-row shadow-sm bg-blue-100 hover:bg-blue-200 rounded p-4 items-center">
        ...
        <div class="col-span-12 sm:col-span-6 md:col-span-3">
          <a href="https://github.com/Mutesa-Cedric/docify" target="_blank" class="flex flex-row shadow-sm bg-green-100 hover:bg-green-200 rounded p-4 items-center">
        ...
        <div class="col-span-12 sm:col-span-6 md:col-span-3">
          <a href="https://github.com/Mutesa-Cedric/docify" target="_blank" class="flex flex-row shadow-sm bg-orange-100 hover:bg-orange-200 rounded p-4 items-center">
